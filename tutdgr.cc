//
// Dynamic Global Routing simulation for NS-3 assignment 7.
//
#include <json/json.h>
...
NS_LOG_COMPONENT_DEFINE("Assignment7Dgr");
...
main(int argc, char* argv[])
{
    ...
    std::string outputDir = "output/data/dgr";
    ...
    for (Json::ArrayIndex i = 0; i < jNodes.size(); ++i)
    {
        ...
        if (jNodes[i]["type"].asString() == "host")
        {
