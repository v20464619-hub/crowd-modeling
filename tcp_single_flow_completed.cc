...
int main(int argc, char *argv[]) {
    ...
    cmd.AddValue("tcpVariant", "TCP variant, e.g. TcpNewReno or TcpVegas.", tcp_variant);
    cmd.AddValue("errorRate", "Bit error rate of the P2P link.", error_rate);
    cmd.AddValue("delay", "P2P link delay, e.g. 10ms or 20ms.", link_delay);
    ...
    em->SetAttribute("ErrorUnit", EnumValue(RateErrorModel::ERROR_UNIT_BIT));
